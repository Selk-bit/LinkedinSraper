...
# Import the Base from your models.py
from db_management.models import Base  # Make sure this path matches your project structure
...
target_metadata = Base.metadata  # Ensure Base.metadata is correctly set here
